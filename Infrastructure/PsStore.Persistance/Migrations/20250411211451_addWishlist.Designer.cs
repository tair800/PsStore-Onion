...
namespace PsStore.Persistance.Migrations
{
    ...
    [Migration("20250411211451_addWishlist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PsStore.Domain.Entities.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PsStore.Domain.Entities.BasketDlc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PsStore.Domain.Entities.BasketGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PsStore.Domain.Entities.ErrorLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PsStore.Domain.Entities.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PsStore.Domain.Entities.BasketDlc", b =>
                {
                    b.HasOne("PsStore.Domain.Entities.Basket", "Basket")
                        .WithMany("BasketDlcs")
                        .HasForeignKey("BasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PsStore.Domain.Entities.Dlc", "Dlc")
                        .WithMany()
                        .HasForeignKey("DlcId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WishlistItem", b =>
                {
                    ...
                    b.HasOne("PsStore.Domain.Entities.Wishlist", "Wishlist")
